defmodule PcrmWeb.CustomerControllerTest do
  use PcrmWeb.ConnCase

  import Pcrm.CustomersFixtures

  @create_attrs %{family_name: "some family_name", given_name: "some given_name"}
  @update_attrs %{family_name: "some updated family_name", given_name: "some updated given_name"}
  @invalid_attrs %{family_name: nil, given_name: nil}
  ...
  describe "update customer" do
    ...
    test "redirects when data is valid", %{conn: conn, customer: customer} do
      ...
      assert html_response(conn, 200) =~ "some updated family_name"
    end
